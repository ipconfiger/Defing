...
> 依据文档：[dev_docs/proposal-v4.md](./proposal-v4.md)（v4.1）、[dev_docs/feasibility-report.md](./feasibility-report.md)（v4.1）、
> 上一版：[dev_docs/design-v1.md](./design-v1.md)（v1.0）
...
Project { id, name, created_at }                       // name 全局唯一
  ...
  └─ （引用选择在分支 BranchState.shared_bindings；结构仅声明 ItemDef.shared 标记——shared-ref-branch-scope）
SharedLibrary
...
发布时把分支 shared_bindings 指向的共享项值**写入版本快照**（版本自包含、不可变）；
...
### 8.3 引用解析与等价性
- 渲染/发布时解析分支 shared_bindings 指向的共享值；未绑定/悬空引用阻断（Block 策略，detail 列出明细）。
...
### 18.3 参考
- [dev_docs/proposal-v4.md](./proposal-v4.md)、[dev_docs/feasibility-report.md](./feasibility-report.md)、[dev_docs/design-v1.md](./design-v1.md)
...
- [rust-embed](https://docs.rs/rust-embed)、[aes-gcm](https://docs.rs/aes-gcm)、[etcd API guarantees](https://etcd.io/dev_docs/v3.8/learning/api_guarantees/)
