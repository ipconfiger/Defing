...
上游: dev_docs/design/project-token.md（已审核通过）
...
| dev_docs/deployment-guide.md | 改 | §3.5/§9/§10 |
| dev_docs/design-modules/05-api.md | 改 | 数据面鉴权说明 |
| dev_docs/design-modules/12-sdk.md | 改 | token 说明 |
