...
状态: v1（已实现并验证：196 工作区测试全绿 + api-surface-test + SDK 契约；实现计划见 dev_docs/aegis/plans/2026-08-20-project-token.md）
日期: 2026-08-20
...
- **文档更新**：deployment-guide §3.5/§9/§10、README 快速开始、契约测试脚本、dev_docs/design-modules/05-api.md 与 12-sdk.md 鉴权说明。
