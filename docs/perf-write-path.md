...
- **P0-1 已完成**（设计 docs/design/perf-write-batch.md，开发计划 docs/plan-perf-write-batch.md）：
...
- **P2 已完成**（方案③ RwLock 读写分离，设计 docs/design/perf-rwlock.md）：
...
- **P0-2 待做**：bench.sh 落盘模式对比行（随本 roadmap 收尾统一补）。
...
- **P1 已完成**（方案② D3 diff/checkpoint 存储，设计 docs/design/perf-diff-storage.md）：
