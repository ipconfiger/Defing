...
关联文档: docs/design-v2.md §4.6-4.7、docs/design-modules/01-core.md、docs/design/storage-redb-migration.md（数据迁移惯例）
...
- docs/design-v2.md §4.6-4.7、docs/design-modules/01-core.md 引用/命令表同步（如审核通过后执行）
