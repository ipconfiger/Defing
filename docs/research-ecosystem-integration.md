...
| **E5 成熟度证据（已有计划）** | 基准归档、k6/ghz 场景脚本 | docs/benchmarks | 基准可复现 | 2–3 天 |
...
- K8s 官方 etcd 有状态应用教程（Raft 引导样板）：https://kubernetes.io/docs/tutorials/stateful-application/run-replicated-stateful-application/
- vault-helm（HA+Raft 的 StatefulSet/PDB/反亲和标杆）：https://developer.hashicorp.com/vault/docs/platform/k8s/helm
...
- Apollo K8s ConfigMap 官方指南：https://github.com/apolloconfig/apollo/blob/master/docs/en/client/k8s-configmap-user-guide.md
- Vault Agent Injector（sidecar 注入标杆）：https://developer.hashicorp.com/vault/docs/platform/k8s/injector
