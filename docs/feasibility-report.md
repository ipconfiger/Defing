...
> 依据文档：[docs/proposal-v4.md](./proposal-v4.md)（需求规格 v4.1）
> 版本：v4.1 ｜ 状态：评审稿
...
- [docs/proposal-v4.md](./proposal-v4.md)（需求规格 v4.0）｜ [docs/proposal-v3.md](./proposal-v3.md) ｜ [docs/proposal-v2.md](./proposal-v2.md) ｜ [docs/proposl.md](./proposl.md)
- [etcd API guarantees](https://etcd.io/docs/v3.8/learning/api_guarantees/)
